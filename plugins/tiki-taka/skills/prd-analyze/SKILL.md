...
3. Read `PLUGIN_ROOT/commands/prd-analyze.md` completely; it is the canonical workflow source.
4. Execute the canonical workflow with the compatibility contract applied.
5. Read every called agent definition under `PLUGIN_ROOT/agents/` completely before executing or
   delegating it. The canonical parallel analyst/scout stage authorizes bounded Codex delegation.
6. Preserve critical PRD challenge, clarification logging, production-gap analysis, publication, and
