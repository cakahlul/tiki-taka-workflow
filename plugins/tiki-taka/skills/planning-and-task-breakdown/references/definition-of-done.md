...
A standing, project-wide bar that every change must clear before it counts as done. Unlike acceptance criteria,
which vary per task, it answers "is this finished to our standard?". Use it as final gate in planning,
incremental implementation, and shipping workflows.
...
- [ ] Architectural decisions worth preserving are recorded in project documentation
...
- **Per release**: the full checklist is the floor; apply deployment-specific gates from the target platform.
