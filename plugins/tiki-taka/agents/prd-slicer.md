...
0. PRD analysis is already the specification. Do not invoke `spec-driven-development` here; slice the
   supplied analysis and project context directly.
...
8. Every clarification returns `NEEDS_INPUT` with up to four concise questions; main asks, records answers, and resumes. Do not call a user-question tool from this worker.
