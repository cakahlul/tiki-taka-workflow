...
grep -q 'event-driven bounded worker pool' "$ROOT/plugins/tiki-taka/context/codex-runtime.md"
...
grep -q '"version": "1.8.0"' "$ROOT/plugins/tiki-taka/.codex-plugin/plugin.json"
grep -q '"version": "1.8.0"' "$ROOT/plugins/tiki-taka/.claude-plugin/plugin.json"
